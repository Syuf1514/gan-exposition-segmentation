...
BIGBIGAN_WEIGHTS = root / 'weights/BigBiGAN_x1.pth'
LATENT_DIRECTION = root / 'weights/bg_direction.pth'
...
def main():
    ...
    parser.add_argument('--gan_weights', type=str, default=str(BIGBIGAN_WEIGHTS))
    parser.add_argument('--bg_direction', type=str, default=str(LATENT_DIRECTION))
